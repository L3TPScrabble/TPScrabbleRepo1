...
public class Plateau extends Application implements PlateauInterface{
	...
	public int ScoreMot(String mot, int i, int j, String d) { //i et j sont les coordonn�es de la premiere lettre de mot, d est la direction du mot(gauche � droite / haut en bas) 
		int temp,g;
		...
		if(d.equals("droite"))
		{
			...
			while(g<temp)
			{
				for(char c : charArray)
				{
					...
					else if(matrice[g][j].getId() == 3) //case de couleur bleu fonc�
		...
		else if(d.equals("bas"))
		{
			...
			while(g<temp)
			{
				for(char c : charArray)
				{
					...
					else if(matrice[i][g].getId() == 3) //case de couleur bleu fonc�
	...
	/*public void addMot(String mot, int i, int j, String d) { //i et j sont les coordonn�es de la premiere lettre de mot, d est la direction du mot(gauche � droite / haut en bas)
		int temp,g;	
		char[] charArray = mot.toCharArray();
		if(d.equals("droite"))
		{
